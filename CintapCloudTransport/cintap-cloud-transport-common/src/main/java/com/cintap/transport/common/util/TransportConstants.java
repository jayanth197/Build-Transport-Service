...
//	public static final String[] edi214Segments = {"L11"};
	public static final String REQUESTED_SHIP_DATE_FORMAT = "yyyy-MM-dd";
	...
	public static final String SERIAL_NUMBER = "/usr/local/tomcat9/webapps/Rhenus-serial-number/";
    ...
    public static final String API_KEY_MISSING = "API Key is required";
}
