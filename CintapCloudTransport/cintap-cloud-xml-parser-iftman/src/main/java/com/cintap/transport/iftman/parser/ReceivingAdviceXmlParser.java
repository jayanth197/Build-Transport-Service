...
@Component
@Slf4j
public class ReceivingAdviceXmlParser {
...
//			System.out.println(inter);
	...
	public static Interface convertXMLToObj(String rhenusXml) {
		...
		try {
			...
			rhenusXml = rhenusXml.replaceAll("xsi:schemaLocation=\"http://www.corelogicllc.com http://b2b.corelogicllc.com/schemas/v2/ReceivingAdvice.xsd\"", "");
