 ...
 */
@Entity
@Table(name = "edifact_desadv_ship_notice_shipment_reference", catalog = "cintap_transport")
@Builder
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
@ToString
public class DespatchAdviceShipNoticeShipmentReference implements java.io.Serializable {
	...
	@JsonIgnoreProperties("lstDesadvShipNoitceShipmentReference")
