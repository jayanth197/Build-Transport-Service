...
@NoArgsConstructor
@AllArgsConstructor
@Table(name = "edifact_orders_message_date_time", catalog = "cintap_transport")
public class OrdersMessageDateTime implements java.io.Serializable {
	...
	@JsonIgnoreProperties("lstOrdersMessageDateTime")
